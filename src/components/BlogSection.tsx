...
const BlogSection = () => {
  return (
    ...
    <div className="container-fluid">
        ...
        <p className="blog_text">There are many variations of passages of Lorem Ipsum available, but the majority have
        ...
        <div className="blog_section_2">
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <p className="ipsum_text">There are many variations of passages of Lorem Ipsum available, but the majority have
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="blog_taital_main">
                            ...
                            <p className="ipsum_text">There are many variations of passages of Lorem Ipsum available, but the majority
                    ...
                    <div className="col-md-6 padding_right_0">
                        <div className="image_5" href="#"><img src="images/img-5.png" /></div>
                    </div>
                </div>
            </div>
            <div className="blog_section_2">
                <div className="row">
                    <div className="col-md-6 padding_left_0">
                        <div className="image_4" href="#"><img src="images/img-6.png" /></div>
                    </div>
                    <div className="col-md-6">
